...
class MainView: UIView {
    ...
    private func setLayout() {
        NSLayoutConstraint.activate([rainbowImage.topAnchor.constraint(equalTo: topAnchor, constant: K.heigh() / 2),
                                     ...
                                     settingButton.bottomAnchor.constraint(equalTo: self.safeAreaLayoutGuide.bottomAnchor, constant: 0),
...
extension MainView {
    ...
    static func makeNewGameButton() -> UIButton {
        ...
        button.backgroundColor = UIColor.newGameButtonCollor
...
extension UIColor {
    ...
    static var newGameButtonCollor: UIColor {
        UIColor(red:  0.871, green: 0.132, blue: 0.132, alpha: 1)
    }
    static var newStatsButtonColor: UIColor {
        UIColor(red: 0.19, green: 0.65, blue: 0.29, alpha: 1)
    }
